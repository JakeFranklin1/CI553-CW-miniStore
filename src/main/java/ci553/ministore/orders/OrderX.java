 ...
 * -----------------------------------------
 * <BR>
 * ALTERNATIVE IMPLEMENTATION OF class Order
 * <BR>
 * -----------------------------------------
 * <P>
 ...
 * This is achieved by holding 3 seperate lists of orders, each list represents
 * a specific
...
public class OrderX implements OrderProcessing {
    ...
    /**
     * Returns information about all the orders (order number) in the order
     * processing system
     * This consists of a map with the orders in the 3 states:
     * "waiting to be processed", "curently being picked" and "waiting to be
     * collected".
     * 
     * <PRE>
